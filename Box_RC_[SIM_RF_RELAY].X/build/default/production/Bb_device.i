...
struct TimeOfDay ToD = {"01","01","01","01","01"};
...
if(PORTBbits.RB7 == 1 && flModeStep == 0 && flStartBitRecieve == 0){
TMR0 = TMR0_Value;
INTCONbits.T0IF = 0;
INTCONbits.T0IE = 1;
TMR1H = 0x00;
...
else if(PORTBbits.RB7 == 0 && flModeStep == 1 && flStartBitRecieve == 1){
T1CONbits.TMR1ON = 0;
...
else if(PORTBbits.RB7 == 1 && flModeStep == 2 && flStartBitRecieve == 1){
T1CONbits.TMR1ON = 1;
flModeStep = 3;

}
else if(PORTBbits.RB7 == 0 && flModeStep == 3 && flStartBitRecieve == 1){
...
else if(PORTBbits.RB7 == 1 && flModeStep == 4 && flStartBitRecieve == 1){
...
else if(PORTBbits.RB7 == 0 && flModeStep == 5 && flStartBitRecieve == 1){
